...
**Features:**
- The A-B loop window can be adjusted using a double-handled slider, <kbd>&leftarrow</kbd> & <kbd>&rightarrow</kbd> on the keyboard, or, more accurately, via two time input fields.
